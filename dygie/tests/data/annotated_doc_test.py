...
class TestEnt(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.annotated_doc = ad.AnnotatedDoc.parse_ann(text_path, ann_path,
                nlp, dataset, coref=True)
        self.annotated_doc.char_to_token()

        # Right answer
        self.ner = [[[0, 0, "City"]],[[6, 7, "Person"], [9, 11, "City"]],
                [[14, 14, "Person"], [16, 16, "Personnel.Election"], [18, 18,
                "Year"]]]
    ...
    def test_format_ner_dygiepp(self):
        ...
        ner = ad.Ent.format_ner_dygiepp(self.annotated_doc.ents, self.sent_idx_tups)
...
class TestEvent(unittest.TestCase):
    ...
    def test_set_arg_objects(self):
        ...
        self.assertEqual(self.event1.args, [self.annotated_doc.ents[3],
                        self.annotated_doc.ents[5]])
...
class TestEquivRel(unittest.TestCase):
    ...
    def test_set_arg_objects(self):
        ...
        self.assertEqual(self.equivrel1.args, [self.annotated_doc.ents[0],
                            self.annotated_doc.ents[2]])
        self.assertEqual(self.equivrel2.args, [self.annotated_doc.ents[1],
                            self.annotated_doc.ents[3]])
...
class TestAnnotatedDoc(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Define right answer
        self.dygiepp_dict = {"doc_key":"myfile",
                        ...
                        "ner":[
                                ...
                                [[14, 14, "Person"], [16, 16,
                                    "Personnel.Election"], [18, 18, "Year"]]
                              ],
                        "relations":[[], [[6, 7, 9, 11, "Mayor-Of"]],[]],
                        "clusters":[[[0,0],[9,11]],[[6,7],[14,14]]],
                        "events":[[],[],
                                [[[16, "Personnel.Election"],[14, 14,
                                    "Person"],[18, 18, "Year"]]]]}
    ...
    def test_char_to_token(self):
        ...
        annotated_doc = ad.AnnotatedDoc.parse_ann(self.txt, self.ann, self.nlp,
                                                    self.dataset, coref=True)
