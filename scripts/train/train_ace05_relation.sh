# Train ACE relation extraction model.
# Usage: bash scripts/train/train_ace05_relation.sh [gpu-id]
# gpu-id can be an integer GPU ID, or -1 for CPU.

experiment_name="ace05-relation"
data_root="./data/ace05/processed-data/json"
config_file="./training_config/ace05_best_relation_bert.jsonnet"
cuda_device=$1
